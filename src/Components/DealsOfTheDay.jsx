        ...
        <div>
            ...
            <div className="grid md:grid-cols-2 gap-4 rounded-lg shadow-orange-300">
                ...
                <div className="border p-5">
                    <div className="flex">
                        <div className="w-1/2">
                            <h1 className="font-bold text-4xl text-pink-600 mb-2 mt-4">Lenovo </h1>
                ...
                <div className="border p-5">
                    <div className="flex">
                        <div className="w-1/2">
                            <h1 className="font-bold text-4xl text-pink-600 mb-2 mt-4">Iphone 8 plus
                            </h1>
                ...
                <div className="border p-5">
                    <div className="flex">
                        <div className="w-1/2">
                            <h1 className="font-bold text-4xl text-pink-600 mb-2 mt-4">Poco x3</h1>
                ...
                <div className="border p-5">
                    <div className="flex">
                        <div className="w-1/2">
                            <h1 className="font-bold text-4xl text-pink-600 mb-2 mt-4">Samsung J2</h1>
